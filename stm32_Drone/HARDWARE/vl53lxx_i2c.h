...
/*IO方向设置*/
//#define SDA_IN()  {GPIOB->MODER&=~(3<<(7*2));GPIOB->MODER|=0<<7*2;}	//PB4输入模式
//#define SDA_OUT() {GPIOB->MODER&=~(3<<(7*2));GPIOB->MODER|=1<<7*2;} //PB4输出模式
/*IO操作函数*/	 
#define VL53_SCL    PBout(6) 	//SCL
#define VL53_SDA    PBout(7) 	//SDA	 

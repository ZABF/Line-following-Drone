...
{
	u8 buf[5]={0XA1,0XA2,0XA3,0XA4,0XA5};
	u8 buf1[5];
	u8 i;   	 
	NRF24L01_Write_Buf(SPI_WRITE_REG+TX_ADDR,buf,5);//写入5个字节的地址.	
	NRF24L01_Read_Buf(TX_ADDR,buf1,5);              //读出写入的地址  	
	for(i=0;i<5;i++)if(buf1[i]!=buf[i])break;					   
...
void ANO_NRF_Check_Event(void)
{
	...
	if(sta & (1<<MAX_RT))
	{
		...
		{
			NRF24L01_Write_Reg(FLUSH_TX,0xff);//清除缓冲区
		}
	}
	////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////
